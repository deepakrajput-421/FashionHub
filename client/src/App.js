     ...
     <BrowserRouter>
      <Routes>
       ...
       {/* admin routes */}
        ...
        <Route path='/add-category' element={<AdminProtectedRoute><AddCategory/></AdminProtectedRoute>}></Route>
        <Route path='/add-coupon' element={<AdminProtectedRoute><AddCoupon/></AdminProtectedRoute>}></Route>
        <Route path='/manage-data' element={<AdminProtectedRoute><Manage/></AdminProtectedRoute>}></Route>
        <Route path='/update/:id' element={<AdminProtectedRoute><UpdateData/></AdminProtectedRoute>}></Route>
        <Route path='/Banner' element={<AdminProtectedRoute><AddBanner/></AdminProtectedRoute>}></Route>
        <Route path='/users' element={<AdminProtectedRoute><ContactMessages/></AdminProtectedRoute>}></Route>
        <Route path='/forgot-password' element=<AdminForgot/>></Route>
       ...
       {/* Pages */}
        ...
        <Route path="/CatData/:gender/:category" element={<CategoryData/>}></Route>
